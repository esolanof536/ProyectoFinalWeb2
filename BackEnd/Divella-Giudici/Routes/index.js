...
const bGController = require('../Controllers/bebidasGaseosasControllers');
const licoresController = require('../Controllers/licoresControllers');
const vinosController = require('../Controllers/vinoControllers');
const especialidadController = require('../Controllers/especialidadesControllers');
const mesaController = require('../Controllers/mesasControllers');
const empleadosController = require('../Controllers/empleadosController');
const puestosController = require('../Controllers/puestosController');
const marcasController = require('../Controllers/marcaControllers');
const comestiblesController = require('../Controllers/comestiblescontrollers');
const empaquesController = require('../Controllers/empaquesControllers');
...
const equipoController = require('../Controllers/tecnologiaControllers');
