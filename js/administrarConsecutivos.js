(function () {
    ...
    const inicializar = async () => {
        consecutivo = document.querySelector('#PrefijoC');
        tipo = document.querySelector('#TDconsecu');
        descripcion = document.querySelector('#descripcionCN');
        valorConsecutivo = document.querySelector('#VConsecutivo');
        btnAceptar = document.querySelector('#btnCconsecutivo');
    ...
    const tabla = async () => {
        ...
        listaConsecutivos.forEach(consecutivo => {
            ...
            <input type="button" data-id="${consecutivo._id}" id="btnEliminar"  class="botons2" value="Eliminar"
